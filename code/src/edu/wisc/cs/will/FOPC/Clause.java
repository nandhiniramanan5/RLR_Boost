...
public class Clause extends Sentence implements DefiniteClause {
	...
	public Clause applyTheta(Map<Variable,Term> theta) {
		...
		Clause newClause = (Clause) stringHandler.getClause(newPosLiterals, newNegLiterals, extraLabel).setWeightOnSentence(wgtSentence).setWeight2OnSentence(weight_2).setWeight0onSentence(weight_0);
