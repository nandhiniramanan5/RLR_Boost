...
public abstract class RegressionInfoHolder {
	...
	public abstract double meanAtSuccess2();
	public abstract double meanAtSuccess0();
	...
	public abstract void addFailureExample(Example eg, long numGrndg, long neg, double weight);
