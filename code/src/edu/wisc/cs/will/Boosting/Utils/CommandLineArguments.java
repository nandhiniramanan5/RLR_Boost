...
public class CommandLineArguments {
	...
	public static final String lamdaswitch = "lamda"; //Nandini lamda
	public static double lamda=5.0;
	...
	public static final String learnrlrclauses = "rlrclause";
	private boolean learningrlrclauses=false;
	
	public static final String numrlrclauses = "numrlrclause";
	private int numberOfrlrclauses=5;
	
	public static final String maxMLNLength = "rlrclauseLen";
	private int maxrlrclauseLength=2;
	...
	public boolean parseArgs(String[] args) {
		for (int i = 0; i < args.length; i++) {		
			...
			if (argMatches(args[i], lamdaswitch)) {
			...
			if (argMatches(args[i], learnrlrclauses)) {
				learningrlrclauses = true;
				if (isArgumentNotAFlag(args, i+1)) {
					learningrlrclauses = Utils.parseBoolean(args[++i]);
				}
				continue;
			}
			if (argMatches(args[i], numrlrclauses)) {
				numberOfrlrclauses=Integer.parseInt(args[++i]);
				continue;
			}
			if (argMatches(args[i], maxMLNLength)) {
				maxrlrclauseLength=Integer.parseInt(args[++i]);
				continue;
			}
	...
	public boolean isLearningMLNClauses() {
		return learningrlrclauses;
	}
	public void setLearningMLNClauses(boolean learningrlrclauses) {
		this.learningrlrclauses = learningrlrclauses;
	}
	public int getNumberOfMLNClauses() {
		return numberOfrlrclauses;
	}


	public void setNumberOfMLNClauses(int numberOfrlrclauses) {
		this.numberOfrlrclauses = numberOfrlrclauses;
	}
	...
	public int getMaxMLNClauseLength() {
		return maxrlrclauseLength;
	}


	public void setMaxMLNClauseLength(int maxrlrclauseLength) {
		this.maxrlrclauseLength = maxrlrclauseLength;
	}
